...
const Sentence = (props) => {
    ...
    return (
        <>
            ...
            }} className={`sentence-container ${props.currentLanguage !== props.originalLanguage ? `${props.sentence.text[props.currentLanguage] ? `parsed-text-sentence translated ${props.translatingSentence === props.sentence.id ? "translated-selected" : null}` : null}` : null}`} >
                {showTranslateTool ?
